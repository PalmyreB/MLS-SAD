 ...
 * @since  2006/11/28
 */
public class DesignMotifIdentificationCallerAzadehMylyn {
	...
	private static final String[] MOTIFS = new String[] { "Command" , "Composite",
			"Decorator", "FactoryMethod", "Observer1", "Prototype" };
	public static void main(final String[] args) {

		try {
			final FileOutputStream logStream =
				new FileOutputStream(
					"../Ptidej Solver Data/ConstraintResultsAzadeh.ini");
			...
			final DesignMotifIdentificationCallerAzadehMylyn ptidejSolver =
				new DesignMotifIdentificationCallerAzadehMylyn();
			...
			//folder of jars to analyse
			final String path =
				"C:/Azadeh/Azadeh Papers/Journal Papers/2015/EMSE/Analyzed Systems/Mylyn/mylyn-3.0.2.v20080918-1100-e3.3/";
			final String destinationPath =
				"../Ptidej Solver Data/MylynEMSE/mylyn-3.0.2.v20080918-1100-e3.3/";
	...
	private void callPtidejSolver(
		...
		try {
			...
			for (int i = 0; i < DesignMotifIdentificationCallerAzadehMylyn.MOTIFS.length; i++) {
				final String motifName =
					DesignMotifIdentificationCallerAzadehMylyn.MOTIFS[i];
			...
			System.out
				.print(DesignMotifIdentificationCallerAzadehMylyn.MOTIFS.length);
