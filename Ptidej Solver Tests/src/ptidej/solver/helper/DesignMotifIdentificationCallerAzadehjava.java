 ...
 * @since  2006/11/28
 */
public class DesignMotifIdentificationCallerAzadehjava {

	private static final String[] MOTIFS = new String[] {"Builder", "Command" , "Composite",
			"Decorator", "FactoryMethod", "Observer1", "Prototype", "Singleton"};
		...
		try {
			final FileOutputStream logStream =
				new FileOutputStream(
					"../Ptidej Solver Data/ConstraintResultsAzadeh.log");
			...
			final DesignMotifIdentificationCallerAzadehjava ptidejSolver =
				new DesignMotifIdentificationCallerAzadehjava();

			final String destinationPath = "../Ptidej Solver Data/";

			final String sourcePath =
				"C:/Users/manel/Desktop/Azadeh/ApacheIgnite/modules/core/java/org/";
			//	"C:/Users/manel/Desktop/Azadeh/HBase/Commit20/";
			//	"C:/Users/manel/Desktop/Azadeh/Matsim/Commit5/";
			final String ClassPath = "";

			final ICodeLevelModel codeLevelmodel =
				padl.creator.javafile.eclipse.test.util.Utils
					.createCompleteJavaFilesPadlModel(
						"AzadehModel",
						sourcePath,
						ClassPath);
			...
			//				final ICodeLevelModel codeLevelModel =
			//						Factory.getInstance().createCodeLevelModel("AzadehModel");
			//				codeLevelModel.create(creator);	

			//				ICodeLevelModel acodeLevelModel =
			//					Factory.getInstance().createCodeLevelModel("AzadehModel");
			//				try {
			//					acodeLevelModel.create(new CompleteJavaFileCreator(
			//							sourcePath,
			//							ClassPath));
			//				}
			...
			//					e.printStackTrace();
			//				}
			ptidejSolver.analyseCodeLevelModelFromPADL(
				"AzadehModel",
				codeLevelmodel,
				destinationPath);
	...
	private void callPtidejSolver(
		...
		try {
			...
			for (int i = 0; i < DesignMotifIdentificationCallerAzadehjava.MOTIFS.length; i++) {
				final String motifName =
					DesignMotifIdentificationCallerAzadehjava.MOTIFS[i];
...
//						.toString();
				...
				//final String path = "../Temp/ConstraintResultsAzadeh in "
				final String path = "../Ptidej Solver Data/ConstraintResultsAzadeh in"
			...
			System.out
				.print(DesignMotifIdentificationCallerAzadehjava.MOTIFS.length);
