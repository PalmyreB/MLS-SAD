...
public class CPPMethodsVisitor implements IWalker {
	private final ArrayList<String> listOfJNIMethods = new ArrayList<String>();
	...
	public void visit(IParameter aParameter) {
		// TODO Auto-generated method stub
		String parameterName = aParameter.getDisplayTypeName();
		String parametertype = aParameter.getDisplayName();
		if (parameterName.contains("ProblemType *") && parametertype.contains("env"))
			this.listOfJNIMethods.add(this.currentMethod.getDisplayName());
	}
