...
public class JNICollecteFctGlobaleVisitor2 implements ICPPWalker {
	...
	/*	if ((aCPPParameter.getDisplayName().contains("env"))
				&&
				 (aCPPParameter.getDisplayTypeName().contains("ProblemType"))
				)
			
			
		{

			 listOfJNIMethods.add(this.currentcppclass.getDisplayName());  */
			
		//	 System.out.println(aCPPParameter.getDisplayName());
			/* listOfJNIMethods.add(this.currentMethod.getDisplayName()
					 +" " +this.currentclass.getDisplayName());*/
