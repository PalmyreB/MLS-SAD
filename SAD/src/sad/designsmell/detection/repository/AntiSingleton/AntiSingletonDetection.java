...
import sad.codesmell.detection.repository.AntiSingleton.*;
...
public class AntiSingletonDetection extends AbstractDesignSmellDetection implements IDesignSmellDetection {
	private final OperatorsCodeSmells operators;
	private final Relationships relations;

	public AntiSingletonDetection() {
		super();
