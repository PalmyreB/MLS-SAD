...
public final class MarkovModelAzadehArgoUML {
  ...
  public static void main(String[] args) {
 		...
 		MarkovModelAzadehArgoUML AModel = new MarkovModelAzadehArgoUML();

	  //  String[] tab1 = new String[12]; 
	  //  String[] tab2 = new String[12];

	    try{
	    		String Infile = "C:/Azadeh/Azadeh Papers/Journal Papers/2015/EMSE/Results/CombineAnti-Design/ArgoUML/ArgoUMLEvolutinResults-Sampleqq.txt";
...
//			    System.out.println(br.readLine());			    	
	    	...
	    	String strFileVer1 = "C:/Azadeh/Azadeh Papers/Journal Papers/2015/EMSE/Results/CombineAnti-Design/ArgoUML/ArgoUMLv0.10.1.csv";
	    	String strFileVer2 = "C:/Azadeh/Azadeh Papers/Journal Papers/2015/EMSE/Results/CombineAnti-Design/ArgoUML/ArgoUMLv0.12.csv";
	    	String strFileVer3 = "C:/Azadeh/Azadeh Papers/Journal Papers/2015/EMSE/Results/CombineAnti-Design/ArgoUML/ArgoUMLv0.14.csv";
	    	String strFileVer4 = "C:/Azadeh/Azadeh Papers/Journal Papers/2015/EMSE/Results/CombineAnti-Design/ArgoUML/ArgoUMLv0.15.6.csv";
	    	String strFileVer5 = "C:/Azadeh/Azadeh Papers/Journal Papers/2015/EMSE/Results/CombineAnti-Design/ArgoUML/ArgoUMLv0.16.csv";
	    	String strFileVer6 = "C:/Azadeh/Azadeh Papers/Journal Papers/2015/EMSE/Results/CombineAnti-Design/ArgoUML/ArgoUMLv0.17.5.csv";
	    	String strFileVer7 = "C:/Azadeh/Azadeh Papers/Journal Papers/2015/EMSE/Results/CombineAnti-Design/ArgoUML/ArgoUMLv0.18.1.csv";
	    	String strFileVer8 = "C:/Azadeh/Azadeh Papers/Journal Papers/2015/EMSE/Results/CombineAnti-Design/ArgoUML/ArgoUMLv0.19.8.csv";
	    	String strFileVer9 = "C:/Azadeh/Azadeh Papers/Journal Papers/2015/EMSE/Results/CombineAnti-Design/ArgoUML/ArgoUMLv0.20.csv";
	    	...
	    	while((nextLineVer2 = readerVer2.readNext()) != null){	    		
	    		...
	    		//	System.out.println("VER2 Contains: " + Ver2[j][lineNumberVer2]);
	    		}
	    		lineNumberVer2 ++;
	   	    }	
	...
	for (int a=0; a<34; a++)
		...
		{
			String Pr1= "";
			Pr1= String.valueOf((double)AModel.version1[a][b]/(total1-724));
			if (AModel.version1[a][b] < 15)
			{
				Pr1 = "0.00";
			}
			if (Pr1.length()>5){
	...
	for (int a=0; a<34; a++)
		...
		{
			String Pr2= "";
			Pr2= String.valueOf((double)AModel.version2[a][b]/(total2-877));
			if (AModel.version2[a][b] < 15)
			{
				Pr2 = "0.00";
			}
			if (Pr2.length()>5){
	...
	for (int a=0; a<34; a++)
		...
		{
			String Pr3= "";
			Pr3= String.valueOf((double)AModel.version3[a][b]/(total3-1270));
			if (AModel.version3[a][b] < 15)
			{
				Pr3 = "0.00";
			}
			if (Pr3.length()>5){
	...
	for (int a=0; a<34; a++)
		...
		{
			String Pr4= "";
			Pr4= String.valueOf((double)AModel.version4[a][b]/(total4-1499));
			if (AModel.version4[a][b] < 18)
			{
				Pr4 = "0.00";
			}
			if (Pr4.length()>5){
	...
	for (int a=0; a<34; a++)
		...
		{
			String Pr5= "";
			Pr5= String.valueOf((double)AModel.version5[a][b]/(total5-762));
			if (AModel.version5[a][b] < 18)
			{
				Pr5 = "0.00";
			}
			if (Pr5.length()>5){
	...
	for (int a=0; a<34; a++)
		...
		{
			String Pr6= "";
			Pr6= String.valueOf((double)AModel.version6[a][b]/(total6-1479));
			if (AModel.version6[a][b] < 18)
			{
				Pr6 = "0.00";
			}
			if (Pr6.length()>5){
	...
	for (int a=0; a<34; a++)
		...
		{
			String Pr7= "";
			Pr7= String.valueOf((double)AModel.version7[a][b]/(total7-1385));
			if (AModel.version7[a][b] < 18)
			{
				Pr7 = "0.00";
			}
			if (Pr7.length()>5){
	...
	for (int a=0; a<34; a++)
		...
		{
			String Pr8= "";
			Pr8= String.valueOf((double)AModel.version8[a][b]/(total8-1350-597));
			if (AModel.version8[a][b] < 20)
			{
				Pr8 = "0.00";
			}
			if (Pr8.length()>5){
	...
	int totallall = total1+total2+total3+total4+total5+total6+total7+total8-(724+877+1270+1499+762+1479+1385+1350+597);
