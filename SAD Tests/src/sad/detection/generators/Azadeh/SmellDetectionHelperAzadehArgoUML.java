 ...
 */
public final class SmellDetectionHelperAzadehArgoUML {
	...
	private SmellDetectionHelperAzadehArgoUML() {
	}
...
*/
			...
			String PATH = "C:/Azadeh/Azadeh Papers/Journal Papers/2017/EMSE/Analyzed Systems/ArgoUML/";
			...
			for (int i = 0; i < listFiles.length; i++) 
			{
				...
				SmellDetectionHelperAzadehArgoUML.analyseCodeLevelModelFromJARs(
					somePaths,
					"ESEM-ArgoUML",
	...
	public static final void analyseCodeLevelModel(
		...
		try {
			for (int i = 0; i < someSmells.length; i++) {
				...
				final String path =
					anOutputDirectory + "Azadeh-ESEM detectionResults in " + aName
	...
	public static final void analyseCodeLevelModel(
		...
		try {
			...
			SmellDetectionHelperAzadehArgoUML.analyseCodeLevelModel(
				someSmells,
				aName,
				idiomLevelModel,
				anOutputDirectory);
	...
	public static final void analyseCodeLevelModelFromAOL(
		...
		try {
			...
			SmellDetectionHelperAzadehArgoUML.analyseCodeLevelModel(
				SmellDetectionHelperAzadehArgoUML.SMELLS,
				aName,
				annotatedCodeLevelModel,
				anOutputDirectory);
		}
	...
	public static final void analyseCodeLevelModelFromJavaClassFiles(
		...
		SmellDetectionHelperAzadehArgoUML.analyseCodeLevelModelFromJavaClassFiles(
			SmellDetectionHelperAzadehArgoUML.SMELLS,
			somePaths,
			aName,
			anOutputDirectoryName);
	...
	public static final void analyseCodeLevelModelFromJavaSourceFilesEclipse(
		...
		SmellDetectionHelperAzadehArgoUML.analyseCodeLevelModelFromJavaSourceFilesEclipse(
			SmellDetectionHelperAzadehArgoUML.SMELLS,
			aSourcePath,
			aName,
			anOutputDirectoryName);
	...
	public static final void analyseCodeLevelModelFromJavaSourceFilesJCT(
		...
		SmellDetectionHelperAzadehArgoUML.analyseCodeLevelModelFromJavaSourceFilesJCT(
			SmellDetectionHelperAzadehArgoUML.SMELLS,
			aSourcePath,
			aName,
			anOutputDirectoryName);
