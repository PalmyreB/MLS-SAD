...
public class BugParserfromCommitsAzadeh {

	public static final String[] BugName = new String[] {"Command", "Composite", "Decorator", "FactoryMethod", "Observer1", "Prototype"};

	private static ArrayList<String> builderParticipants = new ArrayList<String>(Arrays.asList("builder", 
			"client"));	
	private static ArrayList<String> commandParticipants = new ArrayList<String>(Arrays.asList("invoker", "command", "concretecommand", "receiver", 
		...
		private static List<String> singletonParticipants = new ArrayList<String>(Arrays.asList("singleton"));
	...
	public static void main(String[] args) throws FileNotFoundException, IOException {
		...
		designpatterns.put("builder", builderParticipants);
		...
		designpatterns.put("singleton", singletonParticipants);
		
		final String inputDir = "C:/Users/manel/Desktop/TheseManel/Workspace/Ptidej v5/Ptidej Solver Data/Ametys/";		
		final File designpatternresultDir = new File(inputDir);
		//final String output = "C:/Azadeh/Azadeh Papers/Journal Papers/2015/EMSE/Results/Design-Pattern Detection/MylynEMSE/CSV/";
		final String output = "C:/Users/manel/Desktop/TheseManel/Workspace/Ptidej v5/Ptidej Solver Data/Ametys/CSV/";
