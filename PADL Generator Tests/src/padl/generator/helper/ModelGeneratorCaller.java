...
public class ModelGeneratorCaller {
	public static void main(final String[] args) {
		...
		idiomLevelModel =
			ModelGenerator 
				.generateModelFromJavaFilesDirectoryUsingEclipse("C:/Users/Mouna/Desktop/Doc Canada/Thèse/Cours/Automne 2016/LOG6306/TP/JniHelpers-master/src/test/java/com/spotify/jni/");
		//("F:/Snapshots/Eclipse/Test/eclipse_12-15-2009/");
		ModelGeneratorCaller
			.output(
				idiomLevelModel,
				"rsc/Eclipse Snapshot 29-10-2016 (From Java Files, No Ghosts).classe");
	}
	public static void output(
		...
		try {
			...
			/*	// Test Mouna
				...
				else if (firstClassEntity instanceof IField) {
					 writer.write("F");
				}
				
				else if (firstClassEntity instanceof IMethod) {
					 writer.write("M");
				}
				else if (firstClassEntity instanceof IAssociation) {
					writer.write("A");
				}
				//Fin test Mouna */
